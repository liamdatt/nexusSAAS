...
export default function SplashCursor({
    ...
    useEffect(() => {
        ...
        function getWebGLContext(canvas: HTMLCanvasElement) {
            ...
            if (!gl) {
                return null; // silently fail for unsupported environments
            }
    ...
    `
        ...
        function splat(x: number, y: number, dx: number, dy: number, color: ColorRGB) {
            ...
            gl.uniform1f(splatProgram.uniforms.aspectRatio!, canvas!.clientWidth / canvas!.clientHeight);
        ...
        function wrap(value: number, min: number, max: number) {
            ...
            return (value - min) - Math.floor((value - min) / range) * range + min;
        }

        // Attach listeners globally or to canvas
